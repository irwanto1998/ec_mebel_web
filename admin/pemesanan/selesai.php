       ...
       <div class="box-body">
        <table id="example1" class="table table-bordered">
          ...
          <tbody>
            <?php 
              $no = 1;
              $mysql = mysqli_query($koneksi, "SELECT * FROM pemesanan JOIN pelanggan USING(id_p) WHERE pemesanan.status_pesan='Selesai' GROUP BY pemesanan.id_pesan DESC");
