    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <a href="?page=pemesanan/tambah" class="btn btn-sm btn-success pull-right">
       ...
       <div class="box-body">
        <table id="example1" class="table table-bordered">
          ...
          <tbody>
            <?php 
              $no = 1;
              $mysql = mysqli_query($koneksi, "SELECT * FROM pemesanan JOIN pelanggan USING(id_p) GROUP BY pemesanan.id_pesan DESC");
            ...
            <tr>
              ...
              <td><center><?php echo $data['status_pesan'] ?></center></td>
           </tr>
         <?php } ?>
         </tbody>
       </table>
